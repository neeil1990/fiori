...
class Notify extends Simpla
{
	...
	public function email_order_user($order_id)
	{
			...
			$this->email($order->email, $this->settings->site_name.'. '.$subject, $email_template, $this->settings->notify_from_email);
	...
	public function email_order_admin($order_id)
	{
			...
			$subject = $this->design->get_var('subject');
			$this->email($this->settings->order_email, $this->settings->site_name.'. '.$subject, $email_template, $this->settings->notify_from_email);
