...
{	
	...
	{	
 		...
 		if($this->request->method('POST'))
		{
			...
			$this->settings->zphone1 = $this->request->post('zphone1');
			$this->settings->zphone2 = $this->request->post('zphone2');
			$this->settings->zrezhim = $this->request->post('zrezhim');
			$this->settings->zcopy = $this->request->post('zcopy');
			
			$this->settings->vkontakte = $this->request->post('vkontakte');
			$this->settings->twitter = $this->request->post('twitter');
			$this->settings->instagram = $this->request->post('instagram');
