...
{else}
{$meta_title = 'Новый цветок' scope=parent}
{/if}
...
<div class="message message_success">
	<span class="text">{if $message_success=='added'}Цветок добавлен{elseif $message_success=='updated'}Цветок обновлен{else}{$message_success}{/if}</span>
	<a class="link" target="_blank" href="../brands/{$brand->url}">Открыть цветок на сайте</a>
...
<div class="message message_error">
	<span class="text">{if $message_error=='url_exists'}Цветок с таким адресом уже существует{else}{$message_error}{/if}</span>
	<a class="button" href="{$smarty.get.return}">Вернуться</a>
</div>
<!-- Системное сообщение (The End)-->
{/if}
