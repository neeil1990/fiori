...
<div id="header">
	...
	<h1>{$posts_count|plural:'Нашлась':'Нашлись':'Нашлись'} {$posts_count} {$posts_count|plural:'новость':'новостей':'новости'}</h1>
	{elseif $posts_count}
	<h1>{$posts_count} {$posts_count|plural:'новость':'новостей':'новости'}</h1>
	{else}
	<h1>Нет новостей</h1>
	{/if}
	<a class="add" href="{url module=PostAdmin return=$smarty.server.REQUEST_URI}">Добавить новость</a>
</div>	
