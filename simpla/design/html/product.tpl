		...
		<div class="block layer" {if !$categories}style='display:none;'{/if}>
			...
			<ul class="prop_ul">
				{foreach $properties as $property}
					<li><input style="width: 300px; margin-right: 15px" type=text value="{$property->name}" name=new_properties_names[]><input style="width: 100px;"  class="simpla_inp" type="text" name=new_properties_values[] value="{$property->price}" /></li>
				{/foreach}
			</ul>
