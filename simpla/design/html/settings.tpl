...
<input type=hidden name="session_id" value="{$smarty.session.id}">
		...
		<div class="block layer">
			...
			<ul>
				<li><label class=property>Телефон #1</label><input name="zphone1" class="simpla_inp" type="text" value="{$settings->zphone1|escape}" /></li>
				<li><label class=property>Телефон #2</label><input name="zphone2" class="simpla_inp" type="text" value="{$settings->zphone2|escape}" /></li>
				<li><label class=property>Режим работы</label><input name="zrezhim" class="simpla_inp" type="text" value="{$settings->zrezhim|escape}" /></li>
				<li><label class=property>Копирайт</label><input name="zcopy" class="simpla_inp" type="text" value="{$settings->zcopy|escape}" /></li>
			</ul>
			<b style="padding: 0px 0px 15px 0px; display: block;">Социальные сети:</b>
			<ul>
				<li><label class=property>Вконтакте</label><input name="vkontakte" class="simpla_inp" type="text" value="{$settings->vkontakte|escape}" /></li>
				<li><label class=property>Twitter</label><input name="twitter" class="simpla_inp" type="text" value="{$settings->twitter|escape}" /></li>
				<li><label class=property>Instagram</label><input name="instagram" class="simpla_inp" type="text" value="{$settings->instagram|escape}" /></li>
				<li><label class=property>Youtube</label><input name="youtube" class="simpla_inp" type="text" value="{$settings->youtube|escape}" /></li>
				<li><label class=property>Facebook</label><input name="facebook" class="simpla_inp" type="text" value="{$settings->facebook|escape}" /></li>
				<li><label class=property>Одноклассники</label><input name="odnoklassniki" class="simpla_inp" type="text" value="{$settings->odnoklassniki|escape}" /></li>
			</ul>
		</div>
