<?php /* Smarty version Smarty-3.1.18, created on 2018-03-14 10:46:59
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '5000946285a2d7a42baa5f1-02821683',
  'function' => 
  array (
    'category_select' => 
    array (
...
<?php if ($_valid && !is_callable('content_5a2d7a42d90318_66097612')) {function content_5a2d7a42d90318_66097612($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/fiori/web/fiori.su/public_html/Smarty/libs/plugins/modifier.replace.php';
if (!is_callable('smarty_modifier_truncate')) include '/home/fiori/web/fiori.su/public_html/Smarty/libs/plugins/modifier.truncate.php';
...
$(function() {
	...
	var new_property = $('#new_property').clone(true);
	$('#new_property').remove();
	$('#add_new_property').click(function() {
		$(new_property).clone(true).appendTo('ul.new_properties').fadeIn('slow').find("input[name*=new_properties_name]").focus();
		return false;		
	});
...
?>
					<li><input style="width: 300px; margin-right: 15px" type=text value="<?php echo $_smarty_tpl->tpl_vars['property']->value->name;?>
" name=new_properties_names[]><input style="width: 100px;"  class="simpla_inp" type="text" name=new_properties_values[] value="<?php echo $_smarty_tpl->tpl_vars['property']->value->price;?>
" /></li>
				<?php } ?>
			</ul>

			<ul class=new_properties>
				<li id=new_property><input style="width: 300px; margin-right: 15px" type=text name=new_properties_names[]><input style="width: 100px;"  class="simpla_inp" type="text" name=new_properties_values[] /></li>
			</ul>
			<span class="add"><i class="dash_link" id="add_new_property">Добавить новый параметр</i></span>
			<input class="button_green button_save" type="submit" name="" value="Сохранить" />			
		</div>
