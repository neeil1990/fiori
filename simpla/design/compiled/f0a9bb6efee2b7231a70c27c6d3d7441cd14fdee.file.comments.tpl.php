<?php /* Smarty version Smarty-3.1.18, created on 2017-12-10 21:13:04
         compiled from "simpla/design/html/comments.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14337174625a2d79303d78c1-99060972%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '14337174625a2d79303d78c1-99060972',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a2d79304d2bb6_41993900',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a2d79304d2bb6_41993900')) {function content_5a2d79304d2bb6_41993900($_smarty_tpl) {?>
<?php $_smarty_tpl->_capture_stack[0][] = array('tabs', null, null); ob_start(); ?>
	...
	<?php if (in_array('callbacks',$_smarty_tpl->tpl_vars['manager']->value->permissions)) {?><li><a href="index.php?module=CallbacksAdmin">E-mail подписчики</a></li><?php }?>
...
<div id="header">
 ...
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['plural'][0][0]->plural_modifier($_smarty_tpl->tpl_vars['comments_count']->value,'комментарий','комментариев','комментария');?>
 к статьям</h1>
	<?php } elseif ($_smarty_tpl->tpl_vars['type']->value=='feedback') {?>
	<h1><?php echo $_smarty_tpl->tpl_vars['comments_count']->value;?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['plural'][0][0]->plural_modifier($_smarty_tpl->tpl_vars['comments_count']->value,'отзыв','отзывов','отзыва');?>
</h1> 
	<?php }?>
</div>	
...
"/>				
				...
				<div class="name cell">
					...
					<?php if ($_smarty_tpl->tpl_vars['comment']->value->email) {?><a href="mailto:<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['comment']->value->email, ENT_QUOTES, 'UTF-8', true);?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['comment']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</a><?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['comment']->value->name, ENT_QUOTES, 'UTF-8', true);?>
<?php }?>
...
"><?php echo $_smarty_tpl->tpl_vars['comment']->value->product->name;?>
					...
					к новости <a target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['config']->value->root_url;?>
...
"><?php echo $_smarty_tpl->tpl_vars['comment']->value->article->name;?>
				...
				<div class="icons cell">
					<a class="edit" title="Редактировать" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'CommentAdmin','id'=>$_smarty_tpl->tpl_vars['comment']->value->id,'return'=>$_SERVER['REQUEST_URI']),$_smarty_tpl);?>
"></a>
...
'>К фотоальбомам</a></li>
		<li <?php if ($_smarty_tpl->tpl_vars['type']->value=='feedback') {?>class="selected"<?php }?>><a href='<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('keyword'=>null,'type'=>'feedback'),$_smarty_tpl);?>
'>Отзывы</a></li>
	</ul>
