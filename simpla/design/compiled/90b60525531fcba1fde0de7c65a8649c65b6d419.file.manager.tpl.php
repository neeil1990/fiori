<?php /* Smarty version Smarty-3.1.18, created on 2017-12-10 21:08:50
         compiled from "simpla/design/html/manager.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9788995055a2d7832b56961-44961989%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '9788995055a2d7832b56961-44961989',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a2d7832c15bf5_90146871',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a2d7832c15bf5_90146871')) {function content_5a2d7832c15bf5_90146871($_smarty_tpl) {?>
	...
	<div id="column_left">
		...
		<div class="block">
			<ul>
				...
				<?php $_smarty_tpl->tpl_vars['perms'] = new Smarty_variable(array('products'=>'Товары','categories'=>'Категории','brands'=>'Цветок','whoms'=>'Кому','events'=>'Событие','features'=>'Свойства товаров','orders'=>'Заказы','labels'=>'Метки заказов','users'=>'Покупатели','groups'=>'Группы покупателей','coupons'=>'Купоны','pages'=>'Страницы','blog'=>'Блог','photo'=>'Фотоальбом','comments'=>'Комментарии','feedbacks'=>'Обратная связь','import'=>'Импорт','export'=>'Экспорт','backup'=>'Бекап','stats'=>'Статистика','design'=>'Дизайн','settings'=>'Настройки','currency'=>'Валюты','delivery'=>'Способы доставки','payment'=>'Способы оплаты','managers'=>'Менеджеры','callbacks'=>'E-mail подписчики','dmenus'=>'Управление независимым меню','license'=>'Управление лицензией'), null, 0);?>
