<?php /* Smarty version Smarty-3.1.18, created on 2018-10-03 08:31:20
         compiled from "simpla/design/html/brand.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10780594625a3144fc78ace5-17841339%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '10780594625a3144fc78ace5-17841339',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_5a3144fc830e81_08644028',
  'variables' => 
  array (
    'manager' => 0,
    'brand' => 0,
...
<?php if ($_valid && !is_callable('content_5a3144fc830e81_08644028')) {function content_5a3144fc830e81_08644028($_smarty_tpl) {?>
<?php $_smarty_tpl->_capture_stack[0][] = array('tabs', null, null); ob_start(); ?>
	...
	<li class="active"><a href="index.php?module=BrandsAdmin">Цветок</a></li>
...
<?php } else { ?>
<?php $_smarty_tpl->tpl_vars['meta_title'] = new Smarty_variable('Новый цветок', null, 1);
if ($_smarty_tpl->parent != null) $_smarty_tpl->parent->tpl_vars['meta_title'] = clone $_smarty_tpl->tpl_vars['meta_title'];?>
<?php }?>
...
<div class="message message_success">
	<span class="text"><?php if ($_smarty_tpl->tpl_vars['message_success']->value=='added') {?>Цветок добавлен<?php } elseif ($_smarty_tpl->tpl_vars['message_success']->value=='updated') {?>Цветок обновлен<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['message_success']->value;?>
<?php }?></span>
	<a class="link" target="_blank" href="../brands/<?php echo $_smarty_tpl->tpl_vars['brand']->value->url;?>
">Открыть цветок на сайте</a>
	<?php if ($_GET['return']) {?>
...
<div class="message message_error">
	<span class="text"><?php if ($_smarty_tpl->tpl_vars['message_error']->value=='url_exists') {?>Цветок с таким адресом уже существует<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['message_error']->value;?>
<?php }?></span>
	<a class="button" href="<?php echo $_GET['return'];?>
">Вернуться</a>
</div>
