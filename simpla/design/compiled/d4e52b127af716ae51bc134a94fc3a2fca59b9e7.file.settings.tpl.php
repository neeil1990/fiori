<?php /* Smarty version Smarty-3.1.18, created on 2017-12-10 21:07:57
         compiled from "simpla/design/html/settings.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4494688495a2d77fdc48c60-49000384%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '4494688495a2d77fdc48c60-49000384',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a2d77fdd374e3_78141667',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a2d77fdd374e3_78141667')) {function content_5a2d77fdd374e3_78141667($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home/s/svprim4w/svprim4w.beget.tech/public_html/Smarty/libs/plugins/function.math.php';
...
" /></li>
		...
		<div class="block layer">
			...
			<ul>
				<li><label class=property>Телефон #1</label><input name="zphone1" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->zphone1, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
				<li><label class=property>Телефон #2</label><input name="zphone2" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->zphone2, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
				<li><label class=property>Режим работы</label><input name="zrezhim" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->zrezhim, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
				<li><label class=property>Копирайт</label><input name="zcopy" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->zcopy, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
			</ul>
			<b style="padding: 0px 0px 15px 0px; display: block;">Социальные сети:</b>
			<ul>
				<li><label class=property>Вконтакте</label><input name="vkontakte" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->vkontakte, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
				<li><label class=property>Twitter</label><input name="twitter" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->twitter, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
				<li><label class=property>Instagram</label><input name="instagram" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->instagram, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
				<li><label class=property>Youtube</label><input name="youtube" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->youtube, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
				<li><label class=property>Facebook</label><input name="facebook" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->facebook, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
				<li><label class=property>Одноклассники</label><input name="odnoklassniki" class="simpla_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['settings']->value->odnoklassniki, ENT_QUOTES, 'UTF-8', true);?>
" /></li>
			</ul>
		</div>
